...
Expected responses will vary but should include terms related to Structure/Climax.
...
**Definition:** Objects, actions, or concepts that represent deeper meanings beyond their literal significance

**Model Example:** I only have to take a moment to get my eyes strong
...
**Sample Student Response:**
"shown through Matilda's mental preparation: 'I only have to take a moment to get my eyes strong'"
...
## DEVICE 2: Foreshadowing

### Step 1: DEFINITION (Recognition)

**Definition:** Hints or clues about future events in the story

**Model Example:** we are playing with mysterious forces, my child, that we know nothing about
...
**Sample Student Response:**
"shown through Miss Honey's cautionary words: 'we are playing with mysterious forces, my child, that we know nothing about'"
...
## DEVICE 3 (HIGH TIER ONLY): Motif

### Step 1: DEFINITION (Recognition)

**Definition:** Recurring element that develops or reinforces themes throughout the text

**Model Example:** It is a phenomenon
...
**Sample Student Response:**
"shown through Miss Honey's scientific terminology: 'It is a phenomenon'"
...
**Device 1: Symbolism**
- **Correct Answer:** The author's use of Symbolism
- **Where to find:** {{DEVICE_1_LOCATION_PROMPT}}

**Device 2: Foreshadowing**
- **Correct Answer:** The author's use of Foreshadowing
- **Where to find:** {{DEVICE_2_LOCATION_PROMPT}}

**Device 3 (High Tier): Motif**
- **Correct Answer:** The author's use of Motif
...
**Correct Matches:**
- **Device 1:** Symbolism → **Object A:** {{DEVICE_1_OBJECT}}
- **Device 2:** Foreshadowing → **Object B:** {{DEVICE_2_OBJECT}}
- **Device 3 (High Tier):** Motif → **Object C:** {{DEVICE_3_OBJECT}}
...
**Device 1:** The author's use of Symbolism **{{DEVICE_1_VERB}}** {{DEVICE_1_OBJECT}}

**Device 2:** The author's use of Foreshadowing **{{DEVICE_2_VERB}}** {{DEVICE_2_OBJECT}}

**Device 3 (High Tier):** The author's use of Motif **{{DEVICE_3_VERB}}** {{DEVICE_3_OBJECT}}
