...
Usage:
    python3 run_stage2_template.py outputs/Book_stage1b_v5_0.json --week 1
    python3 run_stage2_template.py outputs/Book_stage1b_v5_0.json --all-weeks
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 run_stage2_template.py outputs/Book_stage1b_v5_0.json --week 1")
        print("       python3 run_stage2_template.py outputs/Book_stage1b_v5_0.json --all-weeks")
        sys.exit(1)
