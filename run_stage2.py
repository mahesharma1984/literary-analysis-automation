...
1. **Introduction** (2-3 sentences explaining the macro concept: {macro_focus})

2. **Device Definitions** (Define each device clearly for students)

3. **Text Analysis Activity** (6 analysis questions that guide students to:
   - Identify devices in the text
   - Explain how each device works
   - Connect devices to the macro concept: {macro_focus})

4. **TVODE Construction** (Template and example for students to write TVODE sentences)

5. **Reflection** (2-3 questions for students to synthesize learning)
...
"""
    ...
    print(f"  ✓ Generated {len(worksheet_content):,} characters")
