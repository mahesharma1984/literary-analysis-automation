...
### Section 5: Pedagogical Tier Mapping

### Tier Definitions

Devices are assigned to tiers based on cognitive complexity and scaffolding requirements:

| Tier | Category | Devices | Cognitive Load |
|------|----------|---------|----------------|
| 1 | Concrete/Sensory | Imagery, Simile, Hyperbole, Metaphor | Low - students can visualize |
| 2 | Structural | Dialogue, Repetition, Direct Characterization | Low-Medium - pattern recognition |
| 3 | Abstract Connections | Symbolism, Motif, Foreshadowing, Juxtaposition | Medium - requires inference |
| 4 | Authorial Intent | Verbal Irony, Dramatic Irony, Suspense | Medium-High - requires perspective-taking |
| 5 | Narrative Frame | Third-Person Omniscient, Internal Monologue, Scene, Narrator Reliability | High - meta-level framing |

### Week-Tier-Freytag Alignment Formula

| Week | Freytag Section | Device Tier | Macro Focus |
|------|-----------------|-------------|-------------|
| 1 | Exposition | Tier 1 | Exposition (character/setting intro) |
| 2 | Rising Action | Tier 2 | Rising Action (conflict development) |
| 3 | Climax | Tier 3 | Structure (turning point) |
| 4 | Falling Action | Tier 4 | Rhetoric (authorial intent) |
| 5 | Resolution | Tier 5 | Voice (narrative framing) |

### Kernel Creation Rule

When tagging device examples:

> **Find Tier N device examples in the Freytag section corresponding to Week N.**

Example instructions:

- Tier 1 devices → tag examples from Exposition chapters

- Tier 2 devices → tag examples from Rising Action chapters

- Tier 3 devices → tag examples from Climax chapters

- Tier 4 devices → tag examples from Falling Action chapters

- Tier 5 devices → tag examples from Resolution chapters

### Pervasive Device Handling

Some devices (Voice, Imagery) appear throughout the text. For these:

1. Primary example MUST be from tier-appropriate Freytag section

2. Secondary examples MAY be from other sections

3. Worksheet activities use primary example only
...
**Status:** Protocol v2.0 adds pedagogical tier mapping rules for device assignment.
